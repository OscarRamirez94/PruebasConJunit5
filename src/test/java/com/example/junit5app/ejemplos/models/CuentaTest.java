package com.example.junit5app.ejemplos.models;

import com.example.junit5app.ejemplos.exceptions.DineroInsuficienteException;
...
//        assertNotEquals(cuenta2, cuenta);
   ...
   // @Disabled
    ...
    class PruebasParametrizadasTest{
        ...
        @ParameterizedTest(name = "numero {index} ejecutando con valor {0} - {argumentsWithNames}")
        @CsvSource({"200,100,Andres,Andres", "250,200,Pepe,Pepe", "300,300,Maria,Maria", "510,500,Pepa,Pepa",
                "750,700,Lucas,Lucas", "1000.12345,1000.12345,Cata,Cata"})
